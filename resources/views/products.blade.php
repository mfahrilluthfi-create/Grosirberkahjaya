                ...
                <div class="bg-white rounded-lg shadow p-6">
                    ...
                    <form action="{{ route('products') }}" method="GET">
                        ...
                        <div class="mb-6">
                            ...
                            <div class="space-y-2">
                                <label class="flex items-center">
                                    <input type="radio" name="price_range" value="0-50000"
                                        {{ request('price_range') == '0-50000' ? 'checked' : '' }} class="mr-2"
                                ...
                                <label class="flex items-center">
                                    <input type="radio" name="price_range" value="50000-300000"
                                        {{ request('price_range') == '50000-300000' ? 'checked' : '' }} class="mr-2"
                                        onchange="this.form.submit()">
                                    <span class="text-sm">Rp 50.000 - Rp 300.000</span>
                                </label>
                                ...
                                <label class="flex items-center">
                                    <input type="radio" name="price_range" value="300000-800000"
                                        ...
                                        onchange="this.form.submit()">
                                    <span class="text-sm">Rp 300.000 - Rp 800.000</span>
                                </label>
                            </div>
                        </div>
                        ...
                        @foreach ($products as $product)
                            <div class="bg-white rounded-lg shadow hover:shadow-xl transition">
                                <div class="relative">
                                    ...
                                    @if ($product->stock == 0)
                                        <span
                                            class="absolute top-2 left-2 bg-gray-800 text-white px-2 py-1 rounded text-sm">Stok
                                            Habis</span>
                                    @endif
                                </div>
                                <div class="p-4">
                                    ...
                                    <div class="mb-2">
                                        @if ($product->discount > 0)
                                            ...
                                            <span class="text-blue-600 font-bold text-lg block">Rp
