...
@section('title', 'Produk - ElektroMart')
        ...
        <div class="w-full lg:w-64 flex-shrink-0">
            <div class="bg-white rounded-lg shadow p-6">
                ...
                <form action="{{ route('products') }}" method="GET">
                    ...
                    <a href="{{ route('products') }}" class="w-full bg-gray-200 hover:bg-gray-300 py-2 rounded text-sm text-center block">
                        Reset Filter
                    </a>
                </form>
            </div>
